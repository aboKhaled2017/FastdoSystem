...
namespace Fastdo.backendsys.Migrations
{
    ...
    [Migration("20200924135540_updateTbs_And_AddNewThreeTables")]
    partial class updateTbs_And_AddNewThreeTables
    {
            ...
            modelBuilder.Entity("Fastdo.Repositories.Models.StockWithPharmaClass", b =>
                {
                    ...
                    b.HasIndex("StockId", "ClassName")
                        .IsUnique()
                        .HasFilter("[StockId] IS NOT NULL AND [ClassName] IS NOT NULL");
